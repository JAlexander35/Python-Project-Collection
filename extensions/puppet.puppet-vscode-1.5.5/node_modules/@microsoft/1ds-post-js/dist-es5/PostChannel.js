...
import { _DYN_ADD_HEADER, _DYN_AUTO_FLUSH_EVENTS_LI15, _DYN_BASE_DATA, _DYN_BATCHES, _DYN_CAN_SEND_REQUEST, _DYN_CLEAR_TIMEOUT_OVERRI3, _DYN_CONCAT, _DYN_COUNT, _DYN_DATA, _DYN_DISABLE_AUTO_BATCH_F16, _DYN_DISABLE_OPTIMIZE_OBJ, _DYN_DISABLE_TELEMETRY, _DYN_EVENTS, _DYN_EVENTS_LIMIT_IN_MEM, _DYN_GET_OFFLINE_REQUEST_9, _DYN_GET_WPARAM, _DYN_HDRS, _DYN_IDENTIFIER, _DYN_IGNORE_MC1_MS0_COOKI14, _DYN_INITIALIZE, _DYN_IS_COMPLETELY_IDLE, _DYN_I_KEY, _DYN_LATENCY, _DYN_LENGTH, _DYN_OVERRIDE_INSTRUMENTA17, _DYN_PUSH, _DYN_SEND_ATTEMPT, _DYN_SEND_POST, _DYN_SEND_QUEUED_REQUESTS, _DYN_SEND_SYNCHRONOUS_BAT11, _DYN_SERIALIZE_OFFLINE_EV8, _DYN_SET_TIMEOUT_OVERRIDE, _DYN_SET_UNLOADING, _DYN_SPLICE, _DYN_SPLIT, _DYN_SYNC, _DYN__BACK_OFF_TRANSMISSI13 } from "./__DynamicConstants";
    ...
    function PostChannel() {
        ...
        dynamicProto(PostChannel, _this, function (_self, _base) {
                ...
                doPerf(core, function () { return "PostChannel:initialize"; }, function () {
                    ...
                    try {
                        ...
                        _self._addHook(onConfigChange(theConfig, function (details) {
                            ...
                            _ignoreMc1Ms0CookieProcessing = _postConfig[_DYN_IGNORE_MC1_MS0_COOKI14 /* @min:%2eignoreMc1Ms0CookieProcessing */];
                            ...
                            _autoFlushEventsLimit = _postConfig[_DYN_AUTO_FLUSH_EVENTS_LI15 /* @min:%2eautoFlushEventsLimit */];
                            _maxEventSendAttempts = _postConfig.maxEventRetryAttempts;
                            _maxUnloadEventSendAttempts = _postConfig.maxUnloadEventRetryAttempts;
                            _disableAutoBatchFlushLimit = _postConfig[_DYN_DISABLE_AUTO_BATCH_F16 /* @min:%2edisableAutoBatchFlushLimit */];
                            _setAutoLimits();
                            // Override iKey if provided in Post config if provided for during initialization
                            _overrideInstrumentationKey = _postConfig[_DYN_OVERRIDE_INSTRUMENTA17 /* @min:%2eoverrideInstrumentationKey */];
            ...
            _self.getOfflineSupport = function () {
                var details = _httpManager[_DYN_GET_OFFLINE_REQUEST_9 /* @min:%2egetOfflineRequestDetails */]();
                return {
                    getUrl: function () {
                        return details.url;
                    },
                    ...
                    createPayload: function (evt) {
                        return {
                            ...
                            headers: details[_DYN_HDRS /* @min:%2ehdrs */],
                            data: evt
                        };
                    }
                };
                ...
                if (event[_DYN_SYNC /* @min:%2esync */]) {
                    ...
                    if (_currentBackoffCount || _paused) {
                        ...
                        if (_httpManager) {
                            ...
                            _httpManager[_DYN_SEND_SYNCHRONOUS_BAT11 /* @min:%2esendSynchronousBatch */](EventBatch.create(event[_DYN_I_KEY /* @min:%2eiKey */], [event]), event[_DYN_SYNC /* @min:%2esync */] === true ? 1 /* EventSendType.Synchronous */ : event[_DYN_SYNC /* @min:%2esync */], 3 /* SendRequestReason.SyncEvent */);
                            return;
                        }
                    }
                }
            ...
            _self.setEventQueueLimits = function (eventLimit, autoFlushLimit) {
                ...
                _postConfig[_DYN_AUTO_FLUSH_EVENTS_LI15 /* @min:%2eautoFlushEventsLimit */] = _autoFlushEventsLimit = isGreaterThanZero(autoFlushLimit) ? autoFlushLimit : 0;
                _setAutoLimits();
            ...
            _self[_DYN__BACK_OFF_TRANSMISSI13 /* @min:%2e_backOffTransmission */] = function () {
